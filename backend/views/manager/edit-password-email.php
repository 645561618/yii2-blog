...
<div style="width:700px; margin:auto; padding:auto; font-size: 12px; border: 1px solid #999999;">
        ...
        <div style="width: 700px;">
                ...
                <div style="width: 700px;height:180px">
                        <div style="width: 700px; height: 30px; line-height: 30px; color: #cd3f08; text-indent: 66px;"> 恭喜您已经成功修改后台管理密码，请牢记您的新密码哦！</div>
                        ...
                        <div style="width: 700px; height: 30px; line-height: 30px;  text-indent: 66px;">您的新密码：<span style="color: #000; font-weight: bolder;"><?php echo $pwd;?></span></div>

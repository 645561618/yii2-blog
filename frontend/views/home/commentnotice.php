...
<div style="width:700px; margin:auto; padding:auto; font-size: 12px; border: 1px solid #999999;">
        ...
        <div style="width: 700px;">
                ...
                <div style="width: 700px;height:260px">
                        <div style="width: 700px; height: 30px; line-height: 30px; color: #cd3f08; text-indent: 66px;"> 用户<?=$username?>在<?=$time?>评论了文章！</div>
                        <div style="width: 700px; height: 30px; line-height: 30px;  text-indent: 66px;">评论用户：<span style="color: #000; font-weight: bolder;"><?php echo $username;?></span></div>
                        <div style="width: 700px; height: 30px; line-height: 30px;  text-indent: 66px;">文章ID：<span style="color: #000; font-weight: bolder;"><?php echo $aid;?></span></div>

...
<div style="width:700px; margin:auto; padding:auto; font-size: 12px; border: 1px solid #999999;">
        ...
        <div style="width: 700px;">
                ...
                <div style="width: 700px;height:180px">
                        <div style="width: 700px; height: 30px; line-height: 30px; color: #cd3f08; text-indent: 66px;"> 用户<?php echo $email;?>在<?=date('Y-m-d H:i',$time)?>正在申请友情链接，请及时处理！</div>
                        ...
                        <div style="width: 700px; height: 30px; line-height: 30px;  text-indent: 66px;">网站IP：<span style="color: #000; font-weight: bolder;"><?php echo $ip;?></span></div>
                        <div style="width: 700px; height: 30px; line-height: 30px;  text-indent: 66px;"><a href="http://b.hxinq.com/blog/links-list"><span style="color: #000; font-weight: bolder;">点击这里，进入后台首页查看。</span></a>&nbsp;&nbsp;&nbsp;</div>
                </div>
        </div>

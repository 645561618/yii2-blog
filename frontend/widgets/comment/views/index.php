...
<div class="row">
	<div class="comment col-lg-12 col-md-12 col-sx-12">
	  	<img class="head_img" src=<?php if($headimg){?><?=$headimg?><?php }else{ ?>"/images/default.gif"<?php }?> alt="黄信强博客" title="黄信强博客">
	...
	<div class="col-lg-12 col-md-12 col-sx-12" id="c-head" style="<?php if($result){?>display:block;<?php }else{?>display:none<?php }?>">
